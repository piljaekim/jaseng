            ...
            function useCheck() {
                ...
                if (!code) {
                    ...
                    $.ajax({
                        dataType: 'text',
                        //            url: '/inc/data.php',
                        url: '/index.php/classificationCode/useCheck',
                        data: data,
                        type: 'POST',
...
//                alert($("#code_name").val());return false;
                if(!$("#code_name").val()){
                    alert("코드이름을 입력하세요");
                    return false;
                }
        ...
        <div id="container">
            ...
            <table style="display: block; margin: 0 35%; text-align: center" border="1">
                ...
                <tr>
                        <td><?= $row['CODE']?></td>
                        <td><?= $row['CODE_NAME']?></td>
                        <td><input type="button" onclick="openDialog(<?= $row['CLASSIFICATION_CODE_IDX']?>);" value="수정"></td>
                        <td>
                    ...
                    <div id="dialog<?= $row['CLASSIFICATION_CODE_IDX']?>" class="dialog" title="<?= $row['CODE_NAME']?>수정">
                        <form name="updateForm" method="post" action="/index.php/classificationCode/upDateCodeName">
                            <input type="hidden" name="idx" value="<?= $row['CLASSIFICATION_CODE_IDX']?>">
            ...
            <form name="dataForm" style="display: block; height: 100%; width: 100%;" method="post" action="/index.php/classificationCode/saveData">
                <table style="display: block;">
                    <tr>
                        ...
                        <td>
                            <input type="number" id="code" name="code" placeholder="코드번호" onkeyup="useCheck();" maxlength="3" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="code_name" name="code_name" placeholder="코드이름" required>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
